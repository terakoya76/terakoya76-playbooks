...
STEP 3: You must use the planner subagent (pass to it the full path of the `claude-instance-{id}` directory that contains the 2 reports made by the 2 subagents) that reads both reports and creates a "PLAN.md".
